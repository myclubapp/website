      ...
      <StyledAbout>
        ...
        <div>
          <div className="section starter">
            <h2>Einführung</h2>
            <p>Willkommen bei myclub | the next generation. Diese Nutzungsbedingungen ("Bedingungen") regeln Ihre Nutzung der myclub-Website und mobilen Anwendung ("Dienst"). Durch den Zugriff auf oder die Nutzung unseres Dienstes erklären Sie sich mit diesen Bedingungen und unserer Datenschutzrichtlinie einverstanden.</p>
          </div>
          <div className="section starter">
          ...
          <div className="section starter">
            <h2>Konten</h2>
            <p>a. Um bestimmte Funktionen des Dienstes nutzen zu können, müssen Sie ein Konto erstellen.</p>
            <p>b. Sie sind verantwortlich für die Wahrung der Vertraulichkeit Ihrer Kontozugangsdaten.</p>
            <p>c. Sie erklären sich damit einverstanden, uns sofort zu informieren, wenn Sie von einer Verletzung der Sicherheit oder einer unbefugten Nutzung Ihres Kontos Kenntnis erlangen.</p>
          </div>
          <div className="section starter">
            <h2>Urheberrechte</h2>
          ...
          <div className="section starter">
            <h2>Nutzerinhalte</h2>
            <p>a. Sie behalten alle Rechte an den Inhalten, die Sie an den Dienst übermitteln, und sind allein verantwortlich dafür.</p>
            <p>b. Durch das Veröffentlichen von Inhalten gewähren Sie myclub eine weltweite, nicht-exklusive, gebührenfreie Lizenz zur Nutzung, Vervielfältigung und Darstellung dieser Inhalte in Verbindung mit dem Dienst.</p>
          </div>
          <div className="section starter">
          ...
          <div className="section starter">
            ...
            <p>Der Dienst wird auf einer "AS IS" und "AS AVAILABLE" Basis bereitgestellt.</p>
          </div>
          <div className="section starter">
            <h2>Haftungsbeschränkung</h2>
            <p>Unter keinen Umständen haften myclub | the next generation oder seine Direktoren, Mitarbeiter für indirekte, zufällige, besondere, folgenschwere oder strafende Schäden, die aus Ihrer Nutzung des Dienstes entstehen.</p>
          </div>
          <div className="section starter">
            <h2>Gerichtsstand</h2>
            <p>Diese Bedingungen unterliegen den Gesetzen der Schweiz (Schaffhausen).</p>
          </div>
          <div className="section starter">
            <h2>Änderungen der Bedingungen</h2>
            <p>Wir behalten uns das Recht vor, diese Bedingungen jederzeit nach eigenem Ermessen zu ändern oder zu ersetzen.</p>
          </div>
          <div className="section starter">
            <h2>Kontaktieren Sie uns</h2>
            <p>Wenn Sie Fragen zu diesen Bedingungen haben, kontaktieren Sie uns bitte unter info@my-club.app</p>
          </div>
        </div>
      </StyledAbout>
    </Main>
