  ...
  return (
    <StyledCardGrid>
      <section>
        <h2>Our values</h2>
        <p>
          We work hard to provide the best solution to you. myclub's
          architecture follows these principles:{' '}
          <b>mobile first & always bet on the web.</b>
          the latest version of the app is always available as PWA. In a second
          stage we also support iOS and Android Apps.
        </p>
        <ul className="cards">
          <StyledCard as="li" title={`Project`} key={`Card`}>
            ...
            <div className="card-content">
              ...
              <h3>mobile first</h3>
              <p>
                myclub works best on your smartphone. We use latest web
                technology provided by ionicframework, capacitor and angular.
              </p>
            </div>
          </StyledCard>
          <StyledCard as="li" title={`Project`} key={`Card1`}>
            ...
            <div className="card-content">
              ...
              <h3>open source</h3>
              <p>
                Not sure what happens with your data? have a look at github and
                checkout the code. Wanna help to improve the app? Submit a PR.
              </p>
            </div>
          </StyledCard>
          <StyledCard as="li" title={`Project`} key={`Card2`}>
            ...
            <div className="card-content">
              ...
              <p>
                your data stays in switzerland. we use powerful cloud services,
                all hosted in switzerland.
              </p>
            </div>
          </StyledCard>
          <StyledCard as="li" title={`Project`} key={`Card3`}>
            ...
            <div className="card-content">
              ...
              <p>
                With the integration of the swissunihockey api, you will never
                miss a game again. Checkout the latest stadings of your team and
                celebrate your next win!
              </p>
            </div>
          </StyledCard>
          <StyledCard as="li" title={`Project`} key={`Card4`}>
            ...
            <div className="card-content">
              ...
              <h3>swiss volley</h3>
              <p>
                With the integration of the swiss volley api, you will never
                miss a game again. Checkout the latest stadings of your team and
                celebrate your next win!
              </p>
            </div>
          ...
          <StyledCard as="li" title={`Project`} key={`Card5`}>
            ...
            <div className="card-content">
              ...
              <p>
                With the integration of the swiss handball api, you will never
                miss a game again. Checkout the latest stadings of your team and
                celebrate your next win!
              </p>
            </div>
